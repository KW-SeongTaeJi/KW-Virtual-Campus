...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SEnterIndoor, MakePacket<S_EnterIndoor>);
		_handler.Add((ushort)MsgId.SEnterIndoor, PacketHandler.S_EnterIndoorHandler);		
		_onRecv.Add((ushort)MsgId.SSpawnIndoor, MakePacket<S_SpawnIndoor>);
		_handler.Add((ushort)MsgId.SSpawnIndoor, PacketHandler.S_SpawnIndoorHandler);		
		_onRecv.Add((ushort)MsgId.SDespawnIndoor, MakePacket<S_DespawnIndoor>);
		_handler.Add((ushort)MsgId.SDespawnIndoor, PacketHandler.S_DespawnIndoorHandler);		
		_onRecv.Add((ushort)MsgId.SMoveIndoor, MakePacket<S_MoveIndoor>);
		_handler.Add((ushort)MsgId.SMoveIndoor, PacketHandler.S_MoveIndoorHandler);
	}
