...
namespace LobbyServer.DB
{
    public class WebDbContext : DbContext
    {
        ...
        //string _connectionString = @"Data Source=kwcampus.cixwp6zptiuf.ap-northeast-2.rds.amazonaws.com,1433;Initial Catalog=AccountDB;User id=admin;Password=rlaalsxo1223;";
