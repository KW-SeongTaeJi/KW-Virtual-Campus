...
namespace Server.DB
{
    public class AppDbContext : DbContext
    {
        ...
        //string _connectionString = @"Data Source=kwcampus.cixwp6zptiuf.ap-northeast-2.rds.amazonaws.com,1433;Initial Catalog=MainDB;User id=admin;Password=rlaalsxo1223;";
